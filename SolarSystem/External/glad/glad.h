/*
    ...
    OpenGL loader generated by glad 0.1.14a0 on Fri Sep  1 01:19:05 2017.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.5" --generator="c" --spec="gl" --no-loader --extensions="GL_ARB_clip_control,GL_NV_depth_buffer_float"
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D4.5&extensions=GL_ARB_clip_control&extensions=GL_NV_depth_buffer_float
*/
...
#endif
#define NOMINMAX// Otherwise defines stupid macros in minwindef.h
#include <windows.h>
#undef near				//Still defined some macros
#undef far				//Still defined some macros
#endif
