...
namespace solar
{
	...
	void IMGuiBackend::SetStyle()
	{
		...
		style.Colors[ImGuiCol_Border] = ImVec4(0.06f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		style.Colors[ImGuiCol_FrameBg] = ImVec4(0.16f, 0.16f, 0.16f, 1.00f);
		style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
		style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.13f, 0.35f, 0.79f, 1.00f);
		style.Colors[ImGuiCol_TitleBg] = ImVec4(0.06f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.06f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.12f, 0.24f, 0.82f, 1.00f);
		...
		style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.06f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_ComboBg] = ImVec4(0.10f, 0.10f, 0.10f, 1.00f);
		style.Colors[ImGuiCol_CheckMark] = ImVec4(0.05f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.06f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_Button] = ImVec4(0.04f, 0.16f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_Header] = ImVec4(0.06f, 0.24f, 0.71f, 1.00f);
		style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_Column] = ImVec4(0.06f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_ColumnHovered] = ImVec4(0.90f, 0.78f, 0.00f, 1.00f);
		style.Colors[ImGuiCol_ColumnActive] = ImVec4(0.90f, 0.78f, 0.00f, 1.00f);
		style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
		style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_CloseButton] = ImVec4(0.31f, 0.31f, 0.31f, 1.00f);
		style.Colors[ImGuiCol_CloseButtonHovered] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_CloseButtonActive] = ImVec4(0.04f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_PlotLines] = ImVec4(0.90f, 0.78f, 0.00f, 1.00f);
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.06f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.78f, 0.00f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.06f, 0.24f, 0.82f, 1.00f);
		style.Colors[ImGuiCol_PopupBg] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
		style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.06f, 0.24f, 0.82f, 0.50f);
		style.Colors[ImGuiCol_ModalWindowDarkening] = ImVec4(0.08f, 0.08f, 0.08f, 0.86f);
