...
namespace solar
{
	...
	SimData SolarParser::Load()
	{
		...
		data->push_back(Unit(Vec3d(1429e9, 0.0), Vec3d(0.0, 9638.0), 5.6846e26, "Saturn", Vec4d(1.0, 0.92, 0.78, 1.0)));
		data->push_back(Unit(Vec3d(2870e9, 0.0), Vec3d(0.0, 6795.0), 8.6832e25, "Uran", Vec4d(0.71, 0.98, 0.96, 1.0)));
		data->push_back(Unit(Vec3d(4498e9, 0.0), Vec3d(0.0, 5432.0), 1.0243e26, "Neptun", Vec4d(0.0, 0.3, 0.77, 1.0)));
		//Dwarf planets
		data->push_back(Unit(Vec3d(7375.93e9, 0.0), Vec3d(0.0, 3710.0), 1.303e22, "Pluto", Vec4d(1.0, 1.0, 1.0, 1.0)));

		//Moons
		data->push_back(Unit(Vec3d(150.0e9, 0.0), Vec3d(0.0, 30822.0), 7.3476e22, "Moon", Vec4d(0.2, 0.2, 0.2, 1.0)));
		data->push_back(Unit(Vec3d(225.609376e9, 0.0), Vec3d(0.0, 26238.0), 1.0659e16, "Phobos", Vec4d(0.5, 0.46, 0.3, 1.0)));
		data->push_back(Unit(Vec3d(225.623463e9, 0.0), Vec3d(0.0, 25451.0), 1.4762e15, "Deimos", Vec4d(0.2, 0.8, 0.7, 1.0)));
		data->push_back(Unit(Vec3d(778.9217e9, 0.0), Vec3d(0.0, 30350.0), 8.931938e22, "Io", Vec4d(1.0, 0.2, 0.1, 1.0)));
		data->push_back(Unit(Vec3d(779.1709e9, 0.0), Vec3d(0.0, 26790.0), 4.799844e22, "Europa", Vec4d(1.0, 0.8, 0.7, 1.0)));
		data->push_back(Unit(Vec3d(779.5704e9, 0.0), Vec3d(0.0, 23930.0), 1.4819e23, "Ganymede", Vec4d(0.6, 0.76, 0.95, 1.0)));
		data->push_back(Unit(Vec3d(780.3827e9, 0.0), Vec3d(0.0, 21254.0), 1.075938e23, "Callisto", Vec4d(0.4, 0.1, 0.92, 1.0)));
